...
<!-- Workout carousel -->
<div class="carousel w-full space-x-4 mb-6">
  <div class="carousel-item w-full">
    <div class="card bg-base-200 w-full">
      <div class="card-body">
        <h2 class="card-title">7‑Minute Workout</h2>
        <p>Full body, no equipment</p>
        <p class="text-sm opacity-70">7 minutes</p>
      </div>
    </div>
  </div>
</div>
